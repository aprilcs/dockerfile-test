...
`registry.codeocean.com/codeocean/miniconda3:4.3.30-python3.6.3-ubuntu16.04`
...
docker run --rm \
  ...
  registry.codeocean.com/codeocean/miniconda3:4.3.30-python3.6.3-ubuntu16.04 ./run.sh
```
